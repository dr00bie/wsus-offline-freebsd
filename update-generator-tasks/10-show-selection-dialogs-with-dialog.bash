...
#
# Copyright (C) 2018-2019 Hartmut Buhrmester
...
function show_selection_dialogs_with_dialog ()
{
    ...
    # The three selection dialogs must be defined locally to get the
    ...
    local -a updates_dialog=(
        ...
        w100-x64      "Windows 10 / Server 2016, 64-bit"                    "${all_values[w100-x64]}"

; ***  WSUS Offline Update 11.7.2 - Generator  ***
...
#pragma compile(FileVersion, 11.7.2.1048)
...
#pragma compile(ProductVersion, 11.7.2)

Dim Const $caption                  = "WSUS Offline Update 11.7.2"
...
$txtxpos = 3 * $txtxoffset
If ShowGUIInGerman() Then
  GUICtrlCreateLabel("Microsoft wird die Unterstützung für Windows 7 und Server 2008 (R2) am 14.01.2020 einstellen.", $txtxpos, $txtypos, $groupwidth - 2 * $txtxoffset, $txtheight)
Else
  GUICtrlCreateLabel("Microsoft will discontinue support for Windows 7 and Server 2008 (R2) on 01/14/2020.", $txtxpos, $txtypos, $groupwidth - 2 * $txtxoffset, $txtheight)
EndIf
